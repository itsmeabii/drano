...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-latte flex items-center justify-center p-4 relative overflow-hidden">
      ...
      {/* blobs */}
      <div className="fixed top-[-80px] left-[-80px] w-[300px] h-[300px] rounded-full bg-blush opacity-40 z-0" />
      <div className="fixed bottom-[-60px] right-[-60px] w-[250px] h-[250px] rounded-full bg-lilac opacity-30 z-0" />
      ...
      <div className="bg-white border border-blush rounded-[24px] p-10 w-full max-w-[400px] relative z-10">
        ...
        <p className="font-display text-xl font-semibold text-plum mb-5">welcome back</p>
        ...
        <p className="text-center text-xs text-lilac mt-5">
          no account yet?{' '}
          <Link href="/signup" className="text-plum font-bold">sign up</Link>
        </p>
