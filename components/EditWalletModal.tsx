    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-[24px] border border-blush w-full max-w-lg p-6 z-10 max-h-[80vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <p className="font-display text-2xl font-semibold text-plum">Edit Wallet ✦</p>
          <button onClick={onClose} className="text-lilac hover:text-plum text-2xl transition-colors">✕</button>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          {!isCredit && (
            <div>
              <label className="block text-sm font-semibold text-plum mb-1.5">Current Balance</label>
